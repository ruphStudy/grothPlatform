...
@Module({
  ...
  providers: [StrategySignalService, GrowthObjectiveService, GrowthChannelFitService, GrowthStrategyService],
  exports: [StrategySignalService, GrowthObjectiveService, GrowthChannelFitService, GrowthStrategyService],
})
